...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-4 left-0 right-0 z-50 m-2">
      <div
        className="text-neutral-500 bg-black/60 backdrop-blur-md
      ...
      >
        ...
        {/* center links hidden on mobile view */}
        <div className="hidden md:flex space-x-7">
          ...
          <a href="testimonilas" className="hover:text-neutral-200">
            Testimonials
          </a>
        </div>
        ...
        <div className="hidden md:flex space-x-4 items-center">
          ...
          <a
            href=""
            className="border border-neutral-700 text-white py-2 px-4
        ...
        {/* hamburger only visible for mobile */}
